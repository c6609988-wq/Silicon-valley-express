...
export const mockChannels: Channel[] = [
  {
    ...
    description: 'Elon Musk 的最新动态与 Tesla/...',
    icon: '⚡',
    category: '人物观点',
    sourceCount: 4,
    ...
    tags: ['Elon', 'Tesla', 'xAI'],
    sources: [
      { id: 's-8', name: 'Elon Musk', platform: 'twitter', icon: '𝕏', url: 'https://x.com/elonmusk', description: 'Tesla / SpaceX / xAI CEO', followerCount: 180000000, isFollowed: false, lastUpdated: new Date().toISOString() },
    ],
  },
  {
    id: 'ch-2',
    name: 'OpenAI 核心动向',
    description: '追踪 OpenAI 官方博客、Sa...',
    icon: '🤖',
    category: 'AI 科技',
    sourceCount: 4,
    ...
    tags: ['AI', 'OpenAI', 'GPT'],
    sources: [
      { id: 's-1', name: 'Sam Altman', platform: 'twitter', icon: '𝕏', url: 'https://x.com/sama', description: 'OpenAI CEO', followerCount: 3200000, isFollowed: true, lastUpdated: new Date().toISOString() },
      { id: 's-2', name: 'OpenAI Blog', platform: 'blog', icon: '📝', url: 'https://openai.com/blog', description: 'OpenAI 官方博客', followerCount: 580000, isFollowed: true, lastUpdated: new Date().toISOString() },
    ],
  },
  {
    id: 'ch-3',
    name: 'Sam Altman',
    description: 'OpenAI CEO，硅谷最具影响...',
    icon: '👤',
    category: '人物观点',
    sourceCount: 1,
    ...
    tags: ['AI', 'OpenAI', 'Sam'],
    sources: [
      { id: 's-1b', name: 'Sam Altman', platform: 'twitter', icon: '𝕏', url: 'https://x.com/sama', description: 'OpenAI CEO', followerCount: 3200000, isFollowed: true, lastUpdated: new Date().toISOString() },
    ],
  },
  {
    id: 'ch-4',
    name: 'a16z & Sequoia',
    description: '顶级 VC 的投资动态与行业洞察',
    icon: '💰',
    category: '投资动态',
    sourceCount: 3,
    ...
    tags: ['投资', 'VC', '趋势'],
    sources: [
      { id: 's-4', name: 'Sequoia Capital', platform: 'twitter', icon: '𝕏', url: 'https://x.com/sequoia', description: '红杉资本', followerCount: 950000, isFollowed: true, lastUpdated: new Date().toISOString() },
    ],
  },
  {
    id: 'ch-5',
    name: 'Product Hunt',
    description: '每日最新产品发布，发现下一个...',
    icon: '🚀',
    category: '创业公司',
    sourceCount: 2,
    subscriberCount: 7700,
    isSubscribed: false,
    tags: ['产品', '创业', '发现'],
    sources: [],
  },
  {
    ...
    description: 'Gemini、AlphaFold 等前沿 AI ...',
    icon: '🧬',
    category: 'AI 科技',
    sourceCount: 3,
  ...
  },
  {
    id: 'ch-7',
    name: 'Y Combinator',
    description: 'YC 创业营动态、Demo Day 速报',
    icon: '🎯',
    category: '创业公司',
    sourceCount: 4,
  ...
  },
  {
    ...
    description: 'Claude AI 最新进展与安全 AI 研究',
    icon: '🔬',
    category: 'AI 科技',
    sourceCount: 2,
